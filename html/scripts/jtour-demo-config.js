	...
	$.jTour({
		...
		pages:				[
			{url: 'tour01.html', items: [
				...
				{
				    sel:		'.section.themes',
					msg:		'<p>Each pink circle is the gallery, and the number represents the artworks displayed in that gallery.</p>',
					elemPos:	't',
					boxPos:		't',
					delay:		5000,
					offsetTop:	538,
				...
				{
				    sel:		'.section.themes',
					msg:		'<p>Click on the "add" button to add your favorite gallery into your personal map.</p>',
					elemPos:	't',
					boxPos:		't',
					delay:		5000,
					offsetTop:	350,
	...
	$.jTour({
		...
		pages:				[
			{url: '', items: [
				{
					sel:		'.section.themes',
					title:		'Welcome to ArtWalk website tour',
					msg:		'<p>In this tour, you will be able to see every function here and know how to navigate this website!</p>',
					elemPos:	't',
					boxPos:		't',
					delay:		1000,
					elemPos:	't',
