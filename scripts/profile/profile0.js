...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        $('#holder svg path').eq(0).hover(function(){
                          ...
                          $('#artworks_container li').not('.painting').css('opacity', 0.2);
                          //$('#artworks_container li').filter('.painting').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});

                        });
						 $('#holder svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.video').css('opacity', 0.2);
                          //$('#artworks_container li').filter('.video').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        ...
                        var results = [80, 20];
                        var textes2 = ['Abstract', 'Contemporary'];
                        ...
                        var results = [90,10];
                        var textes3 = ['$10,000-$50,000 ', '$50,000-$100,000', 'Texte 33', 'Texte 34'];
                        ...
                        $('#holder3 svg path').eq(0).hover(function(){
						 ...
						 $('#holder3 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.serious').css('opacity', 0.2);
                          //$('#artworks_container li').filter('.serious').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
						...
						var results = [80,10,10];
                        var textes4 = ['Ronnie Hughes ', 'Deborah Grant', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.RonnieHughes').css('opacity', 0.2);
                          //$('#artworks_container li').filter('.RonnieHughes').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.DeborahGrant').css('opacity', 0.2);
                           //$('#artworks_container li').filter('.DeborahGrant').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.Botner&Pedro').css('opacity', 0.2);
                          //$('#artworks_container li').filter('.Botner&Pedro').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                      });
