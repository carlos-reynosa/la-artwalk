...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [60,40];
                        var textes = ['Painting', 'Drawing', 'Texte 3', 'Texte 4']
                        ...
                        $('#holder svg path').eq(0).hover(function(){
						 ...
						 $('#holder svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.drawing').css('opacity', 0.2);
                          $('#artworks_container li').filter('.drawing').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});

                        });
						
                        var results = [40, 40, 20];
                        var textes2 = ['Surrealism','Abstract', 'Contemporary'];
                        draw_graphique('holder2', 'Contemporary', textes2, results);
						
                         $('#holder2 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.surrealism').css('opacity', 0.2);
                          $('#artworks_container li').filter('.surrealism').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                        ...
                        var results = [60,40];
                        var textes3 = ['$10,000-$50,000 ', 'under $10,000', 'Texte 33', 'Texte 34'];
						...
						var results = [60,40];
                        var textes4 = ['Rory Devine ', 'Tim Nolan', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.RoryDevine').css('opacity', 0.2);
                          $('#artworks_container li').filter('.RoryDevine').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.TimNolan').css('opacity', 0.2);
                           $('#artworks_container li').filter('.TimNolan').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
