...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        $('#holder2 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.abstract').css( "outline", "3px solid #00BCC0");
						...
						var results = [54,46];
                        var textes4 = ['Luke Achterberg ', 'Matt Stone', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.LukeAchterberg').css('opacity', 0.2);
                          $('#artworks_container li').filter('.LukeAchterberg').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.MattStone').css('opacity', 0.2);
                           $('#artworks_container li').filter('.MattStone').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
