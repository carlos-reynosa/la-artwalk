...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [50, 40, 10];
                        var textes2 = ['Representational', 'Surrealism','Abstract'];
						...
						var results = [100,0.01];
                        var textes4 = ['Cindy Wright ', 'Deborah Grant', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.CindyWright').css( "outline", "3px solid #00BCC0");
                          $('#artworks_container li').filter('.CindyWright').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
