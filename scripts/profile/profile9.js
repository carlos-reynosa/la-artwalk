...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [57,43];
                        var textes = ['Paintmaking', 'Mixed Media', 'Texte 3', 'Texte 4']
                        ...
                        $('#holder svg path').eq(0).hover(function(){
                          ...
                          $('#artworks_container li').not('.printmaking').css('opacity', 0.2);
                          $('#artworks_container li').filter('.printmaking').css( "outline", "3px solid #00BCC0");
                        }, function(){
						 ...
						 $('#holder svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.mixedmedia').css('opacity', 0.2);
                          $('#artworks_container li').filter('.mixedmedia').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        ...
                        $('#holder2 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.representational').css( "outline", "3px solid #00BCC0");
						...
						var results = [57,43];
                        var textes4 = [ 'Rubén Ortiz-Torres', 'John Baldessari', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.JohnBaldessari').css('opacity', 0.2);
                          $('#artworks_container li').filter('.JohnBaldessari').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.RubénOrtiz-Torres').css('opacity', 0.2);
                           $('#artworks_container li').filter('.RubénOrtiz-Torres').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
