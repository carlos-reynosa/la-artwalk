...
var colors = ['#EE3E92', '#084A74', '#00B3C0', '#AAD039', '#ff9600'];
...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [77,20,3];
                        var textes = ['Photography', 'Video', 'Texte 3', 'Texte 4']
                        ...
                        var results = [51,26,23];
                        var textes2 = ['Contemporary', 'Cartoonee', 'Symbolism', 'Figurative'];
                        draw_graphique('holder2', 'Contemporary', textes2, results);

                        $('#holder2 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.contemporary').css( "outline", "3px solid #00BCC0");
						...
						var results = [52,23,19,3,3];
                        var textes4 = ['Gary Leonard ', 'Deborah Grant', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.GaryLeonard').css( "outline", "3px solid #00BCC0");
                          $('#artworks_container li').filter('.GaryLeonard').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
