...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [47, 47, 6];
                        var textes2 = ['Abstract', 'Contemporary', 'representational'];
						...
						var results = [53,47];
                        var textes4 = ['Latchkey Kid ', 'Lisa Brugger', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.LatchkeyKid').css('opacity', 0.2);
                          $('#artworks_container li').filter('.LatchkeyKid').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.LisaBrugger').css('opacity', 0.2);
                           $('#artworks_container li').filter('.LisaBrugger').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
