...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [89,11];
                        var textes = ['Painting', 'Mixed Media', 'Texte 3', 'Texte 4']
                        ...
                        $('#holder svg path').eq(0).hover(function(){
						 ...
						 $('#holder svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.mixed').css('opacity', 0.2);
                          $('#artworks_container li').filter('.mixed').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        ...
                        var results = [89, 11];
                        var textes2 = ['Representational', 'Surrealism'];
						...
						var results = [89,11];
                        var textes4 = ['Marius Bercea ', 'Maeghan Reid', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.MariusBercea').css('opacity', 0.2);
                          $('#artworks_container li').filter('.MariusBercea').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.MaeghanReid').css('opacity', 0.2);
                           $('#artworks_container li').filter('.MaeghanReid').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
