...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [67,13,10,10];
                        var textes2 = ['Surrealism', 'Cartoonee', 'Symbolism', 'Figurative'];
                        ...
                        $('#holder2 svg path').eq(0).hover(function(){
                          ...
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.cartoonee').css('opacity', 0.2);
                          $('#artworks_container li').filter('.cartoonee').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						 $('#holder2 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.symbolism').css('opacity', 0.2);
                          $('#artworks_container li').filter('.symbolism').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						...
						var results = [100,0.01];
                        var textes4 = ['Gary Soszynski ', 'Deborah Grant', 'Botner&Pedro', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.GarySoszynski').css( "outline", "3px solid #00BCC0");
                          $('#artworks_container li').filter('.GarySoszynski').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
