...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var textes = ['photography', 'Mixed Media', 'Texte 3', 'Texte 4']
                        ...
                        var results = [57, 43];
                        var textes2 = ['Representational', 'Contemporary'];
                        ...
                        var results = [67,23,10];
                        var textes3 = ['Under $10,000 ', '$10,000-$50,000 ', 'Over $100,000', 'Texte 33', 'Texte 34'];
                        draw_graphique('holder3', 'Remboursements', textes3, results);
                        $('#holder3 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.beginner').css('opacity', 0.2);
                          $('#artworks_container li').filter('.beginner').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						 $('#holder3 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.intermediate').css('opacity', 0.2);
                          $('#artworks_container li').filter('.intermediate').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						 $('#holder3 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.investor').css('opacity', 0.2);
                          $('#artworks_container li').filter('.investor').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						...
						var results = [43,33,24];
                        var textes4 = [ 'Barian','Wang Qingsong', 'Alain Delorme', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.Barian').css('opacity', 0.2);
                          $('#artworks_container li').filter('.Barian').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.WangQingsong').css('opacity', 0.2);
                           $('#artworks_container li').filter('.WangQingsong').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
						  $('#holder4 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.AlainDelorme').css('opacity', 0.2);
                           $('#artworks_container li').filter('.AlainDelorme').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
