...
function draw_graphique(container, title, textes, results)
                ...
                window.onload = function () {
                        ...
                        var results = [100,0.001];
                        var textes = ['Photography ', 'Texte 2', 'Texte 3', 'Texte 4']
                        ...
                        $('#holder svg path').eq(0).hover(function(){
                          ...
                          $('#artworks_container li').not('.photography').css( "outline", "3px solid #00BCC0");
                                                  $('#artworks_container li').filter('.photography').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});

                        });
                        var results = [40, 30, 25, 5];
                        var textes2 = ['Contemporary ', 'Representational', 'Figurative', 'Abstract'];
                        draw_graphique('holder2', 'Contemporary', textes2, results);

                        $('#holder2 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.contemporary').css('opacity', 0.2);
                                                  $('#artworks_container li').filter('.contemporary').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                          ...
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                                                ...
                                                $('#holder2 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.figurative').css('opacity', 0.2);
                                                  $('#artworks_container li').filter('.figurative').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                                                $('#holder2 svg path').eq(3).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                        ...
                        var results = [100,0.001];
                        var textes3 = ['$10,000-$50,000', 'Texte 32', 'Texte 33', 'Texte 34'];
                        draw_graphique('holder3', 'Remboursements', textes3, results);
                        $('#holder3 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.intermediate').css( "outline", "3px solid #00BCC0");
                                                  $('#artworks_container li').filter('.intermediate').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});

                        });
						var results = [45,40,15];
                        var textes4 = ['Brasilia ', 'Juergen Teller', 'Ola Kolehmainen', 'Texte 34'];
                        draw_graphique('holder4', 'Remboursements', textes4, results);
                        $('#holder4 svg path').eq(0).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.Brasilia').css('opacity', 0.2);
                                                  $('#artworks_container li').filter('.Brasilia').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                                                 $('#holder4 svg path').eq(1).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.JuergenTeller').css('opacity', 0.2);
                                                  $('#artworks_container li').filter('.JuergenTeller').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                                                $('#holder4 svg path').eq(2).hover(function(){
                          $('#artworks_container li').css('opacity', 1);
                          $('#artworks_container li').not('.OlaKolehmainen').css('opacity', 0.2);
                                                  $('#artworks_container li').filter('.OlaKolehmainen').css( "outline", "3px solid #00BCC0");
                        }, function(){
                          $('#artworks_container li').css({opacity: 1, outline: 0});
                        });
                };
